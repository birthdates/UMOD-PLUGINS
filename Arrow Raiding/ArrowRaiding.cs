...
namespace Oxide.Plugins
{
    ...
    public class ArrowRaiding : RustPlugin
    {
        ...
        private const string PermissionUse = "arrowraiding.use";
        ...
        private void OnEntityTakeDamage(Door entity, HitInfo info)
        {
            if (info.Weapon == null || !info.IsProjectile() || info.InitiatorPlayer == null ||
                ...
                !info.InitiatorPlayer.IPlayer.HasPermission(PermissionUse)) return;
        ...
        {
            [JsonProperty("Maximum Damage")] public float MaxDamage;

            [JsonProperty("Minimum Damage")] public float MinDamage;
        }

        public class ConfigFile
        {
            [JsonProperty("Arrow Damage")] public Dictionary<string, ArrowDamage> ArrowDamage;

            [JsonProperty("Weapon Multipliers")] public Dictionary<string, float> BowMultipliers;
